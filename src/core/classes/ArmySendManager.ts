...
class ArmySendManager {
  ...
  //
  //     if (direction !== null) {
  //       const armyPaths = this.selectedArmyTargetTiles[direction]
  //       for (let i = 0; i < armyPaths.length; i++) {
  //         const t = armyPaths[i]
  //         if (!t) continue
  //
  //         // Mountain
  //         if (t.mountain && t.owner?.id !== playerId) {
  //           break
  //         }
  //
  //         // Owned Building
  ...
  //
  //           if (t.forest || (t.building && !t.building.isCamp())) {
  //             break
  //           }
  //         }
  //       }
